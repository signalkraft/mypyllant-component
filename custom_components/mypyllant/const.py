...
OPTION_FETCH_CONNECTION_STATUS = "fetch_connection_status"
OPTION_FETCH_DTC = "fetch_dtc"
...
OPTION_FETCH_AMBISENSE_CAPABILITY = "fetch_ambisense_capability"
DEFAULT_UPDATE_INTERVAL = 5 * 60  # in seconds
...
DEFAULT_FETCH_CONNECTION_STATUS = False
DEFAULT_FETCH_DTC = False
DEFAULT_FETCH_EEBUS = False
DEFAULT_FETCH_AMBISENSE_ROOMS = False
DEFAULT_FETCH_ENERGY_MANAGEMENT = False
DEFAULT_FETCH_AMBISENSE_CAPABILITY = False
